...
void UCWidget_RangeWeapon::UpdateSpreadRange(float InRadius, float InMaxRadius)
{
	Radius = InRadius;
	MaxRadius = InMaxRadius;
}

void UCWidget_RangeWeapon::NativeOnInitialized()
{
...
void UCWidget_RangeWeapon::NativeTick(const FGeometry& MyGeometry, float InDeltaTime)
{
